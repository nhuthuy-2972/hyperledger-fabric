...
async function main() {
	try {
		...
		try {
			...
			// 	console.log('\n--> Submit Transaction: UpdateAsset asset1, asset70 does not exist and should return an error');
			// 	await contract.submitTransaction('UpdateAsset', 'asset1', 'blue', '5', 'Tomoko', '300');
			...
			// await contract.submitTransaction('TransferAsset', 'asset14', 'nhuthuy');
			// console.log('*** Result: committed');
